...
function renderPets(list) {
  ...
  grid.innerHTML = list.map(pet => `
    <div class="pet-card">
      <div class="pet-image">
        <img src="${pet.image}" alt="${pet.name}" onerror="this.src='https://placehold.co/400x220/f0f7f3/093825?text=${pet.name}'" />
      ...
      <div class="pet-info">
        ...
        <p class="pet-tagline">${pet.descripcion}</p>
...
function openModal(id) {
  ...
  info.innerHTML = `
    ...
    <p class="pet-modal-desc">${pet.descripcion}</p>
